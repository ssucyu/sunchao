...
<td>${pageContext.request.contextPath}:--<input type="text" value="${pageContext.request.contextPath}"></input></td>
...
<tr>
	...
	<td><a href="${pageContext.request.contextPath }/add.action">增加</a></td>
